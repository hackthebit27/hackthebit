  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: (props) => (
          <h2
            className="text-2xl md:text-3xl font-bold text-gray-900 mt-10 mb-3"
            {...props}
          />
        ),
        h3: (props) => (
          <h3
            className="text-xl md:text-2xl font-semibold text-gray-900 mt-8 mb-2"
            {...props}
          />
        ),
        p: (props) => (
        ...
        // Fenced blocks -> custom CodeBlock
        ...
        table: (props) => (
          <div className="overflow-x-auto my-6">
            <table
              className="min-w-full border border-gray-200 text-left text-gray-900"
              {...props}
            />
          </div>
        ),
        ...
        th: (props) => (
          <th className="border-b border-gray-200 px-3 py-2" {...props} />
        ),
        td: (props) => (
